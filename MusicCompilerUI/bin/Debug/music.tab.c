...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_SONG = 3,                 /* TOKEN_SONG  */
  YYSYMBOL_TOKEN_PLAY = 4,                 /* TOKEN_PLAY  */
  YYSYMBOL_TOKEN_TEMPO = 5,                /* TOKEN_TEMPO  */
  YYSYMBOL_TOKEN_REPEAT = 6,               /* TOKEN_REPEAT  */
  YYSYMBOL_TOKEN_REST = 7,                 /* TOKEN_REST  */
  YYSYMBOL_TOKEN_STOP = 8,                 /* TOKEN_STOP  */
  YYSYMBOL_TOKEN_FOR = 9,                  /* TOKEN_FOR  */
  YYSYMBOL_TOKEN_LBRACE = 10,              /* TOKEN_LBRACE  */
  YYSYMBOL_TOKEN_RBRACE = 11,              /* TOKEN_RBRACE  */
  YYSYMBOL_TOKEN_SEMICOLON = 12,           /* TOKEN_SEMICOLON  */
  YYSYMBOL_TOKEN_NOTE = 13,                /* TOKEN_NOTE  */
  YYSYMBOL_TOKEN_IDENTIFIER = 14,          /* TOKEN_IDENTIFIER  */
  YYSYMBOL_TOKEN_NUMBER = 15,              /* TOKEN_NUMBER  */
  YYSYMBOL_YYACCEPT = 16,                  /* $accept  */
  YYSYMBOL_program = 17,                   /* program  */
  YYSYMBOL_statements = 18,                /* statements  */
  YYSYMBOL_statement = 19,                 /* statement  */
  YYSYMBOL_tempo_statement = 20,           /* tempo_statement  */
  YYSYMBOL_play_statement = 21,            /* play_statement  */
  YYSYMBOL_rest_statement = 22,            /* rest_statement  */
  YYSYMBOL_repeat_statement = 23,          /* repeat_statement  */
  YYSYMBOL_24_1 = 24,                      /* $@1  */
  YYSYMBOL_stop_statement = 25             /* stop_statement  */
};
...
{
       0,   250,   250,   266,   267,   271,   272,   273,   274,   275,
     279,   293,   307,   322,   321,   359
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN_SONG",
  "TOKEN_PLAY", "TOKEN_TEMPO", "TOKEN_REPEAT", "TOKEN_REST", "TOKEN_STOP",
  "TOKEN_FOR", "TOKEN_LBRACE", "TOKEN_RBRACE", "TOKEN_SEMICOLON",
  "TOKEN_NOTE", "TOKEN_IDENTIFIER", "TOKEN_NUMBER", "$accept", "program",
  "statements", "statement", "tempo_statement", "play_statement",
  "rest_statement", "repeat_statement", "$@1", "stop_statement", YY_NULLPTR
};
...
{
       2,    -8,    13,     6,   -11,   -11,    -4,     1,     3,     5,
       7,     9,   -11,   -11,   -11,   -11,   -11,   -11,   -11,     8,
      11,    14,    15,   -11,    10,   -11,   -11,   -11,    16,   -11,
     -11,     4,   -11
};
...
{
       7,     8,     9,    10,    11,     1,     3,    12,     7,     8,
       9,    10,    11,     4,    19,    32,     5,    24,    20,    31,
      21,    23,    22,    25,    26,    28,     0,    27,    30
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,     7,     8,     3,    14,    11,     4,     5,
       6,     7,     8,     0,    13,    11,    10,     9,    15,    29,
      15,    12,    15,    12,    10,    15,    -1,    12,    12
};
...
{
       0,     3,    17,    14,     0,    10,    18,     4,     5,     6,
       7,     8,    11,    19,    20,    21,    22,    23,    25,    13,
      15,    15,    15,    12,     9,    12,    10,    12,    15,    24,
      12,    18,    11
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: TOKEN_SONG TOKEN_IDENTIFIER TOKEN_LBRACE statements TOKEN_RBRACE  */
#line 251 "music.y"
    {
        printf("\nValid Music Program\n");
...
#line 1324 "music.tab.c"
    break;

  case 10: /* tempo_statement: TOKEN_TEMPO TOKEN_NUMBER TOKEN_SEMICOLON  */
#line 280 "music.y"
    {
        if((yyvsp[-1].number) < 30 || (yyvsp[-1].number) > 300) {
            printf("Error: Tempo must be between 30 and 300 BPM.\n");
            exit(1);
        }

        tempo = (yyvsp[-1].number);
        tempo_set = 1;
        printf("Tempo set to %d BPM\n", tempo);
    }
#line 1339 "music.tab.c"
    break;

  case 11: /* play_statement: TOKEN_PLAY TOKEN_NOTE TOKEN_FOR TOKEN_NUMBER TOKEN_SEMICOLON  */
#line 294 "music.y"
    {
        if(note_count < MAX_NOTES) {
            strcpy(notes[note_count], (yyvsp[-3].string));
            durations[note_count] = (yyvsp[-1].number);
            note_count++;
...
#line 1354 "music.tab.c"
    break;

  case 12: /* rest_statement: TOKEN_REST TOKEN_NUMBER TOKEN_SEMICOLON  */
#line 308 "music.y"
    {
        if(note_count < MAX_NOTES) {
...
#line 322 "music.y"
    {
        ...
        repeat_top++;
        repeat_stack[repeat_top] = (yyvsp[-1].number);
        repeat_start_stack[repeat_top] = note_count;
        printf("Starting repeat block (%d times) at note %d\n", 
               (yyvsp[-1].number), note_count + 1);
    }
#line 1380 "music.tab.c"
    break;

  case 14: /* repeat_statement: TOKEN_REPEAT TOKEN_NUMBER TOKEN_LBRACE $@1 statements TOKEN_RBRACE  */
#line 332 "music.y"
    {
...
#line 1409 "music.tab.c"
    break;

  case 15: /* stop_statement: TOKEN_STOP TOKEN_SEMICOLON  */
#line 360 "music.y"
    {
        printf("Stop encountered.\n");
    }
#line 1417 "music.tab.c"
    break;


#line 1421 "music.tab.c"
