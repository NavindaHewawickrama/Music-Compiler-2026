...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_SONG = 258,              /* TOKEN_SONG  */
    TOKEN_PLAY = 259,              /* TOKEN_PLAY  */
    TOKEN_TEMPO = 260,             /* TOKEN_TEMPO  */
    TOKEN_REPEAT = 261,            /* TOKEN_REPEAT  */
    TOKEN_REST = 262,              /* TOKEN_REST  */
    TOKEN_STOP = 263,              /* TOKEN_STOP  */
    TOKEN_FOR = 264,               /* TOKEN_FOR  */
    TOKEN_LBRACE = 265,            /* TOKEN_LBRACE  */
    TOKEN_RBRACE = 266,            /* TOKEN_RBRACE  */
    TOKEN_SEMICOLON = 267,         /* TOKEN_SEMICOLON  */
    TOKEN_NOTE = 268,              /* TOKEN_NOTE  */
    TOKEN_IDENTIFIER = 269,        /* TOKEN_IDENTIFIER  */
    TOKEN_NUMBER = 270             /* TOKEN_NUMBER  */
  };
